    ...
    private ArrayList<AutocompletePrediction> getAutocomplete(CharSequence constraint) {
        ...
        final FindAutocompletePredictionsRequest.Builder requestBuilder =
                FindAutocompletePredictionsRequest.builder()
                        ...
                        .setCountry("PK") //Use only in specific country
...
//                        .setLocationRestriction(bounds)
        ...
        try {
            ...
            Toast.makeText(getContext(), getContext().getResources().getString(R.string.error_contacting) + e.toString(), Toast.LENGTH_SHORT).show();
